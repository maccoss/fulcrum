"""
`fulcrum.fulcrum`: this module contains the main entry point for workflows
"""
...
def fulcrum(
    ...
    **kwargs,
    ...
    """
    Run a workflow using the specified parameters
    ...
    workflow : str|Callable, optional
        ...
        For a list of built-in workflows, see :py:mod:`fulcrum.workflow`.

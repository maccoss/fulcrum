"""
`fulcrum.quant.normalization.registry`: allows registering pluggable backends for normalization
"""
...
def _get_plugins():
    ...
    plugins = entry_points(group="fulcrum.quant.normalization.plugins")

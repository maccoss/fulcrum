"""
`fulcrum.quant.peptide.basic` -- simple quantification backend
"""
...
def quantify_basic(
    ...
    normalization : str | callable | dict (optional)
        Either a normalization backend name (from :py:class:`fulcrum.quant.normalization.registry`), a normalization

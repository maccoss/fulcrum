"""
`fulcrum.search.registry`: allows registering pluggable backends
"""
...
from fulcrum.search.existing import read_existing_results
...
def _get_plugins():
    ...
    plugins = entry_points(group="fulcrum.search.plugins")
